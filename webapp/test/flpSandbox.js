		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inspection Lot - Results Recording",
									"targetURL": "#comreckittzqminsplotrr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comreckittzqminsplotrr-display": {
								"semanticObject": "comreckittzqminsplotrr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.reckitt.zqminsplotrr",
									"url": sap.ui.require.toUrl("com/reckitt/zqminsplotrr")
								}
							}
						}
					}
